...
<script src="{{asset('assets2/js/jquery.slick.min.js')}}"></script>
<script src="{{asset('assets2/js/lightgallery.min.js')}}"></script>
<script src="{{asset('assets2/js/wow.min.js')}}"></script>
<script src="{{asset('assets2/js/ripples.min.js')}}"></script>
<script src="{{asset('assets2/js/particles.min.js')}}"></script>
<script src="{{asset('assets2/js/main.js')}}"></script>

<script src="{{ asset('assets/js/theme.js') }}"></script>

<script src="{{asset('assets3/js/jquery.min.js')}}"></script>
<script src="{{asset('assets3/js/popper.js')}}"></script>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
    ...
    data-cf-beacon='{"rayId":"8a588b8ddfae7f40","serverTiming":{"name":{"cfL4":true}},"version":"2024.7.0","token":"cd0b4b3a733644fc843ef0b185f98241"}'
